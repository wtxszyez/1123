...
The Edit PanoView Preferences script is a module from [KartaVR](https://www.andrewhazelden.com/projects/kartavr/docs/) that lets you customize the default settings for the PanoView image viewing script.
