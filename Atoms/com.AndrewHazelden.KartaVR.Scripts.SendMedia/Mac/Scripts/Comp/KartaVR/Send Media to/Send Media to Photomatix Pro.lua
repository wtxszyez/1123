--[[--
----------------------------------------------------------------------------
Send Media to Photomatix Pro v4.0.1 for Fusion - 2018-12-31
by Andrew Hazelden
...
The Send Media to Photomatix Pro script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send all of the selected loader node files to Adobe Photomatix Pro. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select a set of loader and saver nodes in the flow view. Then run the "Script > KartaVR > Send Media to > Send Media to Photomatix Pro" menu item to load and tonemap the media in Photomatix Pro.
...
function photomatixProLauncher()
	-- Viewer Variables
	viewerProgram = nil
	command = nil
...
print ('Send Media to Photomatix Pro is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
