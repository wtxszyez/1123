--[[--
----------------------------------------------------------------------------
Send Frame to After Effects v4.0.1 - 2019-01-01
by Andrew Hazelden
...
The Send Frame to After Effects script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send your currently selected file loader or saver node files to Adobe After Effects. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select and activate a node in the flow view. Then run the "Script > KartaVR > Send Media to > Send Frame to After Effects" menu item to load the media in After Effects.
...
function afterEffectsLauncher(mediaFileName)
	-- Viewer Variables
	viewerProgram = nil
	command = nil
	...
	elseif platform == 'Mac' then
		...
		if afterEffectsVersion == 0 then
			-- Adobe After Effects CS3
			defaultViewerProgram = '/Applications/Adobe After Effects CS3/Adobe After Effects CS3.app'
		elseif afterEffectsVersion == 1 then
			-- Adobe After Effects CS4
			defaultViewerProgram = '/Applications/Adobe After Effects CS4/Adobe After Effects CS4.app'
		elseif afterEffectsVersion == 2 then
			-- Adobe After Effects CS5
			defaultViewerProgram = '/Applications/Adobe After Effects CS5/Adobe After Effects CS5.app'
		elseif afterEffectsVersion == 3 then
			-- Adobe After Effects CS6
			defaultViewerProgram = '/Applications/Adobe After Effects CS6/Adobe After Effects CS6.app'
		elseif afterEffectsVersion == 4 then
			-- Adobe After Effects CC
			defaultViewerProgram = '/Applications/Adobe After Effects CC/Adobe After Effects CC.app'
		elseif afterEffectsVersion == 5 then
			-- Adobe After Effects CC 2014
			defaultViewerProgram = '/Applications/Adobe After Effects CC 2014/Adobe After Effects CC 2014.app'
		elseif afterEffectsVersion == 6 then
			-- Adobe After Effects CC 2015
			defaultViewerProgram = '/Applications/Adobe After Effects CC 2015/Adobe After Effects CC 2015.app'
		elseif afterEffectsVersion == 7 then
			-- Adobe After Effects CC 2015.3
			defaultViewerProgram = '/Applications/Adobe After Effects CC 2015.3/Adobe After Effects CC 2015.app'
		elseif afterEffectsVersion == 8 then
			-- Adobe After Effects CC 2017
			defaultViewerProgram = '/Applications/Adobe After Effects CC 2017/Adobe After Effects CC 2017.app'
		elseif afterEffectsVersion == 9 then
			-- Adobe After Effects CC 2018
...
if selectedNode then
	...
	print('[Send Frame to After Effects] No media node was selected. Please select and activate a loader or saver node in the flow view.')
	err = true
end
