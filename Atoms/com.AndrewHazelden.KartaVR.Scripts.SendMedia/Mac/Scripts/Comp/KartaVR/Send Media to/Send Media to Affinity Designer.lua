--[[--
----------------------------------------------------------------------------
Send Media to Affinity Designer v4.0 for Fusion - 2018-12-11
by Andrew Hazelden
...
The Send Media to Affinity Designer script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send all of the selected loader node files to Affinity Designer. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select a set of loader and saver nodes in the flow view. Then run the "Script > KartaVR > Send Media to > Send Media to Affinity Designer" menu item to load the media in Affinity Designer.
...
function affinityDesignerLauncher()
	-- Viewer Variables
	viewerProgram = nil
	command = nil
...
print('Send Media to Affinity Designer is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
