--[[--
----------------------------------------------------------------------------
Send Media to Affinity Designer - v4.2 2019-11-05
by Andrew Hazelden
...
The Send Media to Affinity Designer script is a module from [KartaVR](https://www.andrewhazelden.com/projects/kartavr/docs/) that will send all of the selected loader node files to Affinity Designer. 
