--[[--
----------------------------------------------------------------------------
Send Frame to Photomatix Pro v4.0.1 - 2019-01-01
by Andrew Hazelden
...
The Send Frame to Photomatix Pro script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send your currently selected file loader or saver node files to Adobe Photomatix Pro. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select and activate a node in the flow view. Then run the "Script > KartaVR > Send Media to > Send Frame to Photomatix Pro" menu item to load and tonemap the media in Photomatix Pro.
...
function mediaViewerTool(mediaFileName)
	...
	photomatixProLauncher(mediaFileName)
end
...
function photomatixProLauncher(mediaFileName)
	-- Viewer Variables
	viewerProgram = nil
	command = nil
	...
	elseif platform == 'Linux' then
		-- Running on Linux
		print('Photomatix Pro is not available for Linux yet.')
	else
...
print ('Send Frame to Photomatix Pro is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
...
if selectedNode then
	...
	print('[Send Frame to Photomatix Pro] No media node was selected. Please select and activate a loader or saver node in the flow view.')
	err = true
end
