--[[--
----------------------------------------------------------------------------
Send Frame to PTGui v4.0.1 for Fusion - 2018-12-31
by Andrew Hazelden
...
The Send Frame to PTGui script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send your currently selected file loader or saver node files to the PTGui Stitching program. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select and activate a node in the flow view. Then run the "Script > KartaVR > Send Media to > Send Frame to PTGui" menu item to load the media in PTGui.
...
print ('Send Frame to PTGui is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
...
if selectedNode then
	...
	elseif toolAttrs.TOOLS_RegID == 'Saver' then
		...
		imageFilename = 'kvr_ptgui_' .. selectedNode.Name .. '.' .. viewportSnapshotImageFormat
	...
	print('[Send Frame to PTGui] No media node was selected. Please select and activate a loader or saver node in the flow view.')
	err = true
end
