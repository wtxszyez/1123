--[[--
----------------------------------------------------------------------------
Send Frame to Autopano Pro v4.0.1 - 2019-01-01
by Andrew Hazelden
...
The Send Frame to Autopano Pro script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send your currently selected file loader or saver node files to Autopano Pro. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select and activate a node in the flow view. Then run the "Script > KartaVR > Send Media to > Send Frame to Autopano Pro" menu item to load the media in Autopano Pro.
...
function mediaViewerTool(mediaFileName)
	...
	autopanoProLauncher(mediaFileName)
end
...
function autopanoProLauncher(mediaFileName)
	-- Viewer Variables
	viewerProgram = nil
	command = nil
...
print ('Send Frame to Autopano Pro is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
...
if selectedNode then
	...
	print('[Send Frame to Autopano Pro] No media node was selected. Please select and activate a loader or saver node in the flow view.')
	err = true
end
