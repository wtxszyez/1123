--[[--
----------------------------------------------------------------------------
Send Media to Photoshop v4.0.1 for Fusion - 2018-12-31
by Andrew Hazelden
...
The Send Media to Photoshop script is a module from [KartaVR](http://www.andrewhazelden.com/blog/downloads/kartavr/) that will send all of the selected loader node files to Adobe Photoshop. 

How to use the Script:

Step 1. Start Fusion and open a new comp. Select a set of loader and saver nodes in the flow view. Then run the "Script > KartaVR > Send Media to > Send Media to Photoshop" menu item to load the media in Photoshop.
...
print ('Send Media to Photoshop is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
...
imageFormat = getPreferenceData('KartaVR.SendMedia.Format', 0, printStatus)
