--[[--
----------------------------------------------------------------------------
Send Media to Autopano Pro v4.0.1 for Fusion - 2018-12-31
by Andrew Hazelden
...
Step 1. Start Fusion and open a new comp. Select a set of loader and saver nodes in the flow view. Then run the "Script > KartaVR > Send Media to > Send Media to Autopano Pro" menu item to load the media in Autopano Pro .
...
print ('Send Loaders to Autopano Pro is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
