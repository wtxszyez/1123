--[[--
----------------------------------------------------------------------------
Send Media to Affinity Photo v4.0 for Fusion - 2018-12-11
by Andrew Hazelden
...
Step 1. Start Fusion and open a new comp. Select a set of loader and saver nodes in the flow view. Then run the "Script > KartaVR > Send Media to > Send Media to Affinity Photo" menu item to load the media in Affinity Photo.
...
function affinityPhotoLauncher()
	-- Viewer Variables
	viewerProgram = nil
	command = nil
...
print ('Send Loaders to Affinity Photo is running on ' .. platform .. ' with Fusion ' .. eyeon._VERSION)
