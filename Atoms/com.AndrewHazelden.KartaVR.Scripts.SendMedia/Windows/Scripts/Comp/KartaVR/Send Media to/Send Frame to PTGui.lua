--[[--
----------------------------------------------------------------------------
Send Frame to PTGui - v4.2 2019-11-05
by Andrew Hazelden
...
The Send Frame to PTGui script is a module from [KartaVR](https://www.andrewhazelden.com/projects/kartavr/docs/) that will send your currently selected file loader or saver node files to the PTGui Stitching program. 
