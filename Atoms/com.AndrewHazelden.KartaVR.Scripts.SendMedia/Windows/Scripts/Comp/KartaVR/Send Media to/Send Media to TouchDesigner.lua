--[[--
----------------------------------------------------------------------------
Send Media to TouchDesigner v4.1 2019-10-22
by Andrew Hazelden
...
The Send Media to TouchDesigner script is a module from [KartaVR](https://www.andrewhazelden.com/projects/kartavr/docs/) that will send all of the selected loader node files to the TouchDesigner program. 
