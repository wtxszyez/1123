...
The "Fuse Scanner.lua" script requires Fusion 9.0.1+ to be used.
...
function Main()
	...
	function win.On.FuseScannerWin.Close(ev)
		disp:ExitLoop()
	end
	...
	function UpdateTree()
		...
		itm.FuseScannerWin.WindowTitle = 'Fuse Scanner: ' .. c .. ' Files'
