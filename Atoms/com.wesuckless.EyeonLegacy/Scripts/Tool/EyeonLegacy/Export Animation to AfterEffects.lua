...
This script converts an animated input of the current tool to text data that can be copy
& pasted into AfterEffects (CS3 and above). You can export number and point controls to
position, anchor, scale, opacity or rotation.
...
Version 2.0, 2019-11-05: (Andrew Hazelden andrew@andrewhazelden.com) Fix Fusion v16.1.1 eyeon._VERSION issue
