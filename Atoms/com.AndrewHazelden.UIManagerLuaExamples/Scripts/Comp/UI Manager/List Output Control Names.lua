--[[-
List Output Control Names v2 - 2019-11-02
by Andrew Hazelden
...
Overview:
This script is a Fusion Lua based UI Manager example that works in Fusion v9-16.1+ and Resolve v15-16.1+. The example displays a list of the output control names for the currently selected node in a ui:Tree view. 
