...
Use this script to deactivate your openCL settings in Fusion.

If you are using Resolve v15-16.1+ or Fusion v16+ you might need to add more nodes to the OpenCLNodeList Lua table in this script if your GPU is causing headaches on certain GPU accelerated nodes.
...
function win.On.DisableOpenCLPrefButton.Clicked(ev)
	comp:Print('\n\n-------------------------------------------\n\n')
	comp:Print('[Disabling OpenCL in Comp Preferences]\n\n')
