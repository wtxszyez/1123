...
Overview:
This script is a Fusion Lua based UI Manager example that works in Fusion v9-16.1+ and Resolve v15-16.1+. It uses the HTML loading capacity of the ui:textField to display an image.
...
base64Imagename = comp:MapPath('Reactor:/Deploy/Scripts/comp/UI Manager/fusion-logo.png.base64')
