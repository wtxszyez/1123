--[[--
Fusion Composite Viewer - v3 2019-11-04
by Andrew Hazelden <andrew@andrewhazelden.com>
www.andrewhazelden.com

Overview:
This script allows you to quickly view a syntax highlighted version of the active Fusion composite in a UI Manager based view. It is a Fusion Lua based UI Manager example that works in Fusion v9-16.1+ and Resolve v15-16.1+.
