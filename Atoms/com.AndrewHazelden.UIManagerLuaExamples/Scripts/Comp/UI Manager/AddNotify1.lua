...
win = disp:AddWindow({
	...
	ui:VGroup{
		...
		ui:Label{ID = 'SaveLabel',
			Text = 'Save your Fusion comp to see the AddNotify() event in action.',
			Alignment = {
				AlignHCenter = true,
				AlignTop = true,
			},
...
notify1 = ui:AddNotify('Comp_Save', comp)
notify2 = ui:AddNotify('Comp_SaveVersion', comp)
notify3 = ui:AddNotify('Comp_SaveAs', comp)
notify4 = ui:AddNotify('Comp_SaveCopyAs', comp)
